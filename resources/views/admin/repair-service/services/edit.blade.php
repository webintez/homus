...
<div class="px-6 py-8">
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            <div>
                <h2 class="text-4xl font-bold bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 bg-clip-text text-transparent">Edit Service</h2>
                <p class="mt-3 text-lg text-gray-600 dark:text-gray-300">Update the service information</p>
            </div>
        ...
        <div class="px-6 py-6 bg-gradient-to-r from-indigo-50 to-purple-50 dark:from-indigo-900/20 dark:to-purple-900/20 border-b border-indigo-200 dark:border-indigo-800">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-600 dark:text-gray-400">Update the information below to modify this service</p>
                </div>
            </div>
        </div>
