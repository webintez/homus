...
<head>
    ...
    <title>{{ $service->name }} - Home Appliance Repair</title>
    <!-- Fonts -->
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <a href="{{ route('services') }}" class="text-gray-600 hover:text-gray-900 px-3 py-2 rounded-md text-sm font-medium">
                        Services
                    </a>
    ...
    <div class="max-w-4xl mx-auto py-6 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                <div>
                    <a href="{{ route('services') }}" class="text-indigo-600 hover:text-indigo-500 text-sm font-medium">
                        ← Back to Services
                    </a>
